...
public class ContractClauseMappersImpl implements ContractClauseMappers {
    ...
    @Override
    public ContractClause requestDTOToDomain(ContractClauseRequest clauseRequest) {
        if ( clauseRequest == null ) {
            return null;
        }

        ContractClause.ContractClauseBuilder contractClause = ContractClause.builder();

        contractClause.clauseNumber( clauseRequest.getClauseNumber() );
        contractClause.title( clauseRequest.getTitle() );
        contractClause.content( clauseRequest.getContent() );
        contractClause.mandatory( clauseRequest.isMandatory() );
